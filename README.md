...
- Privilege Analysis is free to use in 19C which can greatly improve application security
...
# source the CDB database that will contain the migrated database
export ORACLE_SID=CDB1
. oraenv

# run command generated by runMigration.sh on SOURCE, e.g.
./runMigration.sh -c MIGRATION19/'"DiHX9B7#qm"' -t 172.17.0.3:1521/DB121 -p DB1

# alternatively, the CDB can be specified as an argument to avoid sourcing it separately
./runMigration.sh -c MIGRATION19/'"DiHX9B7#qm"' -t 172.17.0.3:1521/DB121 -p DB1 -o CDB1
